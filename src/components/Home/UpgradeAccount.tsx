  ...
  return (
    <>
      <div className='container m-2 mr-4 ml-4 bg-gray-100 p-3 max-w-full md:max-w-2xl rounded-xl'>
        <h2 className='mx-2 text-xl md:text-2xl fond-bold font-extrabold text-center mb-3 font-alata'>
          ...
          {regularType ? (
            <>
              ...
              <div className='max-w-full w-full mt-2 flex justify-center items-center text-l'>
                <button
                  className='w-full font-alata py-2 px-4 bg-blue-600 hover:bg-green-600 active:bg-green-700 rounded-md text-white text-md font-bold disabled:opacity-50'
            ...
            <>
              ...
              <div className='max-w-full w-full mt-2 flex justify-center items-center text-l'>
                <button
                  ...
                  className='w-full font-alata py-2 px-4 bg-blue-600 hover:bg-red-600 active:bg-red-700 rounded-md text-white text-md font-bold disabled:opacity-50'
                >
                  Downgrade Account
                </button>
              </div>
